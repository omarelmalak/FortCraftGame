...
public class Room implements Serializable {
    ...
    /**
     * The troll in the current room
     */
    public Troll roomTroll;
    ...
    public String getObjectString() {
        ...
        for (AdventureObject object : this.objectsInRoom) {
            if (!objectsList.contains(object.getDescription())) {
                objectsList.add(object.getDescription());
            }
        }
    ...
    public String getCommands() {
        ...
        for (Passage pass : this.motionTable.getDirection()) {
            if (!directionsList.contains(pass.getDirection())) {
                directionsList.add(pass.getDirection());
            }
        }
    ...
    /**
     * Returns true if there is a troll in the room; otherwise, returns false.
     *
     */

    public boolean checkTroll(){
        return this.roomTroll != null;
    }
